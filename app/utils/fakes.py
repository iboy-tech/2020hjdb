...
lostfound = LostFound(kind=0, status=1, claimant_id=None, user_id=2, location="西苑足球场", title="手机掉了", about="白色苹果手机",
                      images="upload_7702946183392903652.jpg", category_id=1, look_count=1)
