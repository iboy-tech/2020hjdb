...
def register_blueprints(app):
    app.register_bp(admin_bp)  # 管理员
    app.register_bp(auth_bp)  # 认证
    app.register_bp(user_bp)  # 用户
    app.register_bp(page_bp)  # 分页
    app.register_bp(category_bp)  # 分类
    app.register_bp(notice_bp)  # 通知
    app.register_bp(userlist_bp)  # 用户管理
    app.register_bp(found_bp)  # 用户管理
    app.register_bp(feedback_bp)  # 用户管理
    app.register_bp(detail_bp)  # 用户管理
